...
if(message.content.toLowerCase() === `${prefix}help`){
    ...
    .addField(`**website**`, `[https://hightechrobo.com ]`, true)
    .addField(`Mod logs`, `[ \`${prefix}Setmodlog #channel/channel id \` ]`, true)
        .addField(`Report pleyer`, `[ \`${prefix}report  mantion/id reason \` ]`, true)
